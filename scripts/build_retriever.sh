...
# # Build DB and index based on 100K data
# CUDA_VISIBLE_DEVICES=$DEVICE \
#   CUDA_LAUNCH_BLOCKING=1 \
#   python $PROJECT_DIR/src/faisslib/build_retriever.py \
#     --data_dir $PROJECT_DIR/corpus/formatted/wikipedia-split \
...
# # Build DB and index based on 500K data
# CUDA_VISIBLE_DEVICES=$DEVICE \
#   CUDA_LAUNCH_BLOCKING=1 \
#   python $PROJECT_DIR/src/faisslib/build_retriever.py \
#     --data_dir $PROJECT_DIR/corpus/formatted/wikipedia-split \
...
# # Build DB and index based on 1M data
# CUDA_VISIBLE_DEVICES=$DEVICE \
#   CUDA_LAUNCH_BLOCKING=1 \
#   python $PROJECT_DIR/src/faisslib/build_retriever.py \
#     --data_dir $PROJECT_DIR/corpus/formatted/wikipedia-split \
...
# Build DB and index based on 10M data
CUDA_VISIBLE_DEVICES=$DEVICE \
  CUDA_LAUNCH_BLOCKING=1 \
  python $PROJECT_DIR/src/faisslib/build_retriever.py \
    --data_dir $PROJECT_DIR/corpus/formatted/wikipedia-split \
...
# # Build DB and index based on 20M data
# CUDA_VISIBLE_DEVICES=$DEVICE \
#   CUDA_LAUNCH_BLOCKING=1 \
#   python $PROJECT_DIR/src/faisslib/build_retriever.py \
#     --data_dir $PROJECT_DIR/corpus/formatted/wikipedia-split \
